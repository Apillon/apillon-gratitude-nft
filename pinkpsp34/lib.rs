...
pub mod pinkpsp34 {
    ...
    impl PinkPsp34 {
        ...
        pub fn new(name: String, symbol: String, max_supply: u64) -> Self {
            ...
            instance.pinkmint.limit_per_account = 1;
            instance
        }
    ...
    mod tests {
        ...
        const NAME: &str = "ApillonGratitudeNFT";
        const SYMBOL: &str = "AGNFT";
        const TOKEN_URI: &str = "ipfs://base-uri/";

        fn init() -> PinkPsp34 {
            // let accounts = default_accounts();
            let pink34 = PinkPsp34::new(String::from(NAME), String::from(SYMBOL), MAX_SUPPLY);
